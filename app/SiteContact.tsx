    ...
    <section id="contact" className="contact" aria-labelledby="contact-title">
      ...
      <footer>
        ...
        <p>
          ...
          <a href="tel:+971502077215" dir="ltr">+971 50 207 7215</a><br />
          ...
          <a href={publicAsset(localizedPath("/privacy", locale))}>{isArabic ? "الخصوصية" : "Privacy"}</a> · <a href={publicAsset(localizedPath("/terms", locale))}>{isArabic ? "الشروط" : "Terms"}</a><br />
