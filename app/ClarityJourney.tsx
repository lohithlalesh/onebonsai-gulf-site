...
const steps = { en: [
  ...
  {
    label: "تشخيص",
    title: "تحديد مسار العمل الجدير بالتطوير والتحسين.",
    copy: "نشخّص مسار العمل، الأطراف المعنية، الأنظمة، مراحل انتقال المهام، مواطن التعطّل، قبل تحديد أين يمكن للذكاء الاصطناعي أن يضيف قيمة.",
    outcomes: ["خريطة الأنظمة", "أولويات حالات الاستخدام", "مقاييس نجاح واضحة"],
    image: "/media/clarity-diagnose-3d-v1.jpg",
  },
  {
    label: "إدماج",
    title: "البناء على منظومتك الحالية وتطويرها بما يلائم احتياجاتك.",
  ...
  {
    label: "التوسّع",
    title: "تحقيق النمو انطلاقاً من منهجية مثبتة.",
    copy: "ندرّب المستخدمين، نحدّد المسؤوليات، نضع الضوابط اللازمة قبل توسيع نطاق اعتمادها من قِبل فريق آخر.",
