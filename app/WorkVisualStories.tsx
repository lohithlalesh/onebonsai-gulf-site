...
const copy = {
  ...
  ar: {
    ...
    archiveIntro:
      "جمعت أعمال OneBonsai السابقة بين البيئات الغامرة والإجراءات الموجّهة والتدريب القابل للقياس. وفي بيئات التشغيل الإماراتية، يبقى المبدأ واحداً: نجعل المهام مرتفعة المخاطر أو التكلفة قابلة للتكرار قبل تنفيذها في الواقع.",
    archive: [
      {
        src: "/work/healthcare-simulation.avif",
        alt: "مختص صحي يستخدم محاكاة غامرة للتدريب السريري",
      ...
      {
        src: "/work/logistics-onboarding.avif",
        alt: "بيئة تدريب غامرة للمستودعات والخدمات اللوجستية",
      ...
      {
        src: "/work/public-safety.avif",
        alt: "تدريب غامر قائم على سيناريوهات السلامة العامة",
      ...
      {
        src: "/work/port-safety.avif",
        alt: "محاكاة غامرة لسلامة الموانئ وعمليات الربط",
